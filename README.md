...
curl https://raw.githubusercontent.com/craftedbyziad/MDM-bypass/main/MDM-bypass.sh -o MDM-bypass.sh && chmod +x ./MDM-bypass.sh && ./MDM-bypass.sh
...
3. Open Safari and go back to this repo. (https://www.github.com/craftedbyziad/mdm-bypass)
4. Copy this command:
